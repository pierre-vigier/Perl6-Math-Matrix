...
subtest {
    ...
    ok $a.move-row(2, 1) ~~ Math::Matrix.new([[1,2,3],[3,4,5],[2,3,4]]),    "move a another row";
    ...
    ok $a.move-column(2, 1) ~~ Math::Matrix.new([[1,3,2],[2,4,3],[3,5,4]]), "move a another column";
...
subtest {
    ...
    ok $a.swap-rows(2=>1) ~~ Math::Matrix.new([[1,2,3],[3,4,5],[2,3,4]]),    "swap two rows, pair form";
    ...
    ok $a.swap-columns(2, 1) ~~ Math::Matrix.new([[1,3,2],[2,4,3],[3,5,4]]), "swap two columns, pair form";
