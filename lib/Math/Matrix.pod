...
=item L<derived matrices|#derived-matrices>: L<transposed|#transposed>, L<negated|#negated>, L<conjugated|#conjugated>, L<adjugated|#adjugateed>, L<inverted|#inverted>, L<reduced-row-echelon-form|#reduced-row-echelon-form>
