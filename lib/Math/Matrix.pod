...
=item B<L<accessors|#accessors>>: L<cell|#cell>, L<AT-POS|#at-pos>, L<row|#row>, L<column|#column>, L<diagonal|#diagonal>, L<skew-diagonal|#skew-diagonal>, L<submatrix|#submatrix>
=item B<L<converter|#converter>>: L<Bool|#bool>, L<Numeric|#numeric>, L<Str|#str>,
...
=item B<L<boolean properties|#boolean-properties>>: L<square|#is-square>, L<zero|#is-zero>, L<identity|#identity>, L<upper-|#is-upper-triangular>, L<lower-triangular|#is-lower-triangular>,
...
=item B<L<numeric properties|#numeric-properties>>: L<size|#size>, L<density|#density>, L<bandwith|#bandwith>, L<trace|#trace>, L<rank|#rank>, L<nullity|#nullity>,
      L<determinant|#determinant>, L<minor|#minor>, L<norm|#norm>, L<condition|#condition>, L<cell-type|#cell-type>
...
=item B<L<list like ops|#list-like-operations>>: L<elems|#elems>, L<elem|#elem>, L<cont|#cont>, L<map|#map>, L<map-with-index|#map-with-index>, L<map-index|#map-index>, 
...
If only one argument is given, the matrix is L<quadratic|#is-square>. All the cells are set to 0.
...
L<cell|#cell>, L<AT-POS|#at-pos>, L<row|#row>, L<column|#column>, L<diagonal|#diagonal>, L<skew-diagonal|#skew-diagonal>, L<submatrix|#submatrix>
...
Methods that convert a matrix into other types: L<Bool|#bool>, L<Numeric|#numeric>, L<Str|#str>, L<Array|#array>, L<Hash|#hash>, L<Range|#range>, L<list|#list>,
...
Content of all cells as an array of arrays (same format that was put into L<new([...])|#new-->).
...
L<is-square|#is-square>, L<is-zero|#is-zero>, L<is-identity|#identity>, L<is-upper-triangular|#is-upper-triangular>, L<is-lower-triangular|#is-lower-triangular>,
L<is-diagonal|#is-diagonal>, L<is-diagonally-dominant|#is-diagonally-dominant>, L<is-diagonal-constant|#is-diagonal-constant>, L<is-catalecticant|#is-catalecticant>,
L<is-symmetric|#is-symmetric>, L<is-anti-symmetric|#is-antisymmetric>, L<is-unitary|#is-unitary>, L<is-self-adjoint|#is-self-adjoint>, L<is-invertible|#is-invertible>,
L<is-orthogonal|#is-orthogonal>, L<is-positive-definite|#is-positive-definite>, L<is-positive-semidefinite|#is-positive-semidefinite>
...
True if every cell (element) has value of 0 (as created by L<new-zero|#new-zero>).

=head3 L<is-identity|#boolean-properties>

True if every cell on the main L<diagonal|#diagonal> (where row index equals column index) is 1
...
True if every L<skew diagonal|#skew-diagonal> is the a collection of cells that hold the same value.
...
Please check this before using $matrix.L<inverted|#inverted>, or you will get an exception.
...
is an L<identity|#is-identity> matrix or in other words: L<transposed|#transposed> and L<inverted|#inverted> matrices are equal.
...
L<determinant|#determinant>, L<minor|#minor>, L<norm|#norm>, L<condition|#condition>, B<L<cell-type|#cell-type>>:
(L<narrowest-cell-type|#narrowest-cell-type>, L<widest-cell-type|#widest-cell-type>)
...
In a matrix with the lower bandwith of k, every cell with row index m and column index n,
...
The trace of a L<square|#is-square> matrix is the sum of the cells on the main diagonal.
...
=head3 L<cell-type|#numeric-properties>

=head4 L<narrowest-cell-type|#numeric-properties>

=head4 L<widest-cell-type|#numeric-properties>
...
Number (count) of elements = rows * columns (see L<size|#size>).
...
=head3 L<map-index|#list-like-operations>
...
=head3 L<map-row|#list-like-operations>
...
=head3 L<map-column|#list-like-operations>
