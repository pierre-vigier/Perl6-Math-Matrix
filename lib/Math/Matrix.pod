...
=item list like ops: elems, elem, map, map-row, map-column, map-cell, reduce, reduce-rows, reduce-columns
...
Asks if certain value is present in cells (treating the matrix like a Bag),
