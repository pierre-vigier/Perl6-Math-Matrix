...
=item B<L<boolean properties|#boolean-properties>>: L<square|#is-square>, L<triangular|#is-triangular>, L<frobenius|#is-frobenius>,
      L<zero|#is-zero>, L<identity|#identity>, L<diagonal|#is-diagonal>, L<-dominant|#is-diagonally-dominant>, L<-constant|#is-diagonal-constant>, L<catalecticant|#is-catalecticant>,
...
True if all L<element|#element>s above or below the main L<diagonal> are zero.
This method accepts four optional, boolean arguments:
L<:upper|upper_triangular>, I<:lower>, I<:strict> and I<:unit>.
