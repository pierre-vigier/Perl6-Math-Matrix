...
=item B<L<constructors|#constructors>>: L<new []|#new-->, L<new ()|#new---1>, L<new ""|#new---2>,
      L<new-zero|#new-zero>, L<new-identity|#new-identity>, L<new-diagonal>, L<new-vector-product>
...
=item B<L<numeric properties>>: L<size>, L<density>, L<bandwith>, L<trace>, L<rank>, L<nullity>, L<determinant>, L<minor>, L<norm>, L<condition>, L<element-type>
=item B<L<derived matrices>>: L<transposed>, L<negated>, L<conjugated>, L<adjugated>, L<inverted>, L<reduced-row-echelon-form>
...
=item B<L<structural ops|#structural-operations>>: L<move-row>, L<move-column>, L<swap-rows>, L<swap-columns>,
      L<splice-rows>, L<splice-columns>
...
Methods that convert a matrix into other types: L<Bool>, L<Str>, L<Numeric>, L<Range>, L<Array>, L<Hash>, L<list>,
L<list-rows>, L<list-columns> or allow different views on the overall content (output formats): L<gist>, L<perl>.
