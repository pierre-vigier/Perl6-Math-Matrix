...
All rows or colums have to be independent vectors. Please use this method before use: $matrix.inverted,
...
The dot product of a matrix with its L<inverted|#inverted> results in a L<identity|#is-identity> matrix
