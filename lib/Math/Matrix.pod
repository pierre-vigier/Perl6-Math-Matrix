...
=item accessors: cell, row, column, L<diagonal|#diagonal>, L<submatrix|#submatrix>, L<AT-POS|#at-pos>
=item conversion: Bool, Numeric, Str, Array, Hash, list, list-rows, list-columns, L<gist|#gist>, L<perl|#perl>
...
=item numeric properties: size, density, trace, determinant, rank, kernel, norm, condition, narrowest-cell-type, widest-cell-type
