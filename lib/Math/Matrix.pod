...
=head1 METHODS
=item L<constructors|#constructors>: L<new []|#new-->, L<new ()|#new--->, L<new ''|#new---1>, L<new-zero|#new-zero>, L<new-identity|#new-identity>, L<new-diagonal|#new-diagonal>, L<new-vector-product|#new-vector-product>
...
This is the same format as expected by L<Math::Matrix.new("")|#new---1>.
