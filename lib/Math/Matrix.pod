...
=item B<L<boolean properties|#boolean-properties>>: L<square|#is-square>, L<triangular|#is-triangular>, L<tridiagonal|#is-tridiagonal>,
...
L<zero|#is-zero>, L<identity|#is-identity>,
L<square|#is-square>, B<L<triangular|#is-triangular>>,
L<tridiagonal|#is-tridiagonal>, L<diagonal|#is-diagonal>,
L<diagonal-constant|#is-diagonal-constant>, L<catalecticant|#is-catalecticant>,
L<symmetric|#is-symmetric>, L<anti-symmetric|#is-antisymmetric>,
L<self-adjoint|#is-self-adjoint>,
...
operation. Every matrix multiplied with a zero matrix is a zero matrix (A * 0 = 0).
...
Neutral element in redgards to the L<dot-product|#dot-product>. Every matrix
multiplied with a fitting identiy matrix results in the same matrix again (A * I = A).
Every identity matrix has to be a square matrix.
...
This method accepts five optional, boolean arguments:
...
a.k.a unitriangular matrices have a L<diagonal|#diagonal> consisting only of values equal one.
