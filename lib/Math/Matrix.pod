...
True if every L<element|#element> below the L<diagonal|#diagonal> (where row index is greater than column index) is 0.
...
True if every L<element|#element> above the L<diagonal|#diagonal> (where row index is smaller than column index) is 0.
...
Checks two matrices for equality. They have to be of same size and every L<element|#element>
