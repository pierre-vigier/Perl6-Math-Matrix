...
=item L<list like ops|#list-like-ops>: L<elems|#elems>, L<cont|#cont>, L<equal|#equal>, L<map|#map>, L<map-row|#map-row>, L<map-column|#map-column>, L<map-cell|#map-cell>, L<reduce|#reduce>, L<reduce-rows|#reduce-rows>, L<reduce-columns|#reduce-columns>
=item L<structural ops|#structural-ops>: L<move-row|#move-row>, L<move-column|#move-column>, L<swap-rows|#swap-rows>, L<swap-columns|#swap-columns>, L<splice-rows|#splice-rows>, L<splice-columns|#splice-columns>
=item L<matrix math ops|#matrix-math-ops>: L<add|#add>, L<subtract|#subtract>, L<add-row|#add-row>, L<add-column|#add-column>, L<multiply|#multiply>, L<multiply-row|#multiply-row>, L<multiply-column|#multiply-column>, L<dotProduct|#dotProduct>, L<tensorProduct|#tensorProduct>
...
=begin table
    ...
    conj   L<conjugated|#conjugated>
    det    L<determinant|#determinant>
    rref   L<reduced-row-echelon-form|#reduced-row-echelon-form>
=end table
