...
True if every skew diagonal is the a collection of cells that hold the same value.
...
Means the L<transposed|#transposed> and I<negated|#negated> matrix are the same.
