...
=item L<matrix math ops|#matrix-math-operations>: L<equal|#equal>, L<add|#add>, L<subtract|#subtract>, L<multiply|#multiply>, L<dot-product|#dot-product>, L<tensor-product|#tensor-product>
...
They are: L<equal|#equal>, L<add|#add>, L<add|#subtract>, L<multiply|#multiply>, L<dot-product|#dot-product>, L<tensor-product|#tensor-product>.
...
If you provide a row or column number it will be only added to that,
row or column or single cell (when both provided).
...
=item infix -  -->  L<subtract|#subtract>
