...
=item B<L<converter|#type-conversion-and-output-formats>>: L<Bool|#bool>, L<Numeric|#numeric>, L<Str|#str>,
...
=item B<L<boolean properties|#boolean-properties>>: L<zero|#is-zero>, L<identity|#identity>, L<square|#is-square>, L<diagonal|#is-diagonal>, L<diagonal-constant|#is-diagonal-constant>, 
...
=item B<L<numeric properties|#numeric-properties>>: L<size|#size>, L<density|#density>, L<trace|#trace>, L<determinant|#determinant>, L<rank|#rank>, L<nullity|#nullity>,
...
=item B<L<list like ops|#list-like-matrix-operations>>: L<elems|#elems>, L<elem|#elem>, L<cont|#cont>,
...
=item B<L<structural ops|#structural-matrix-operations>>: L<move-row|#move-row>, L<move-column|#move-column>, L<swap-rows|#swap-rows>, L<swap-columns|#swap-columns>,
...
Matrix does not have to be a quadratic (L<square|#is-square>).
...
Matrices that have a L<square|#is-square> form and a full L<rank|#rank> can be inverted (see L<is-invertible|#is-invertible>).
...
Most ops are L<aliases|#operator-methods>.
