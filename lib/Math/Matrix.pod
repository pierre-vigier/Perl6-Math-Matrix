...
L<square|#is-square>, L<triangular|#is-triangular>, L<upper-triangular|#is-upper-triangular>, L<lower-triangular|#is-lower-triangular>,
L<frobenius|#is-frobenius>,
L<zero|#is-zero>, L<identity|#identity>, L<diagonal|#is-diagonal>,
L<diagonally-dominant|#is-diagonally-dominant>, L<diagonal-constant|#is-diagonal-constant>, L<catalecticant|#is-catalecticant>,
...
True if matrix  I<is-upper-triangular> or I<is-lower-triangular>.
When optional named boolean argument :strict is added, the matrix has to be a
strictly upper triangula or a strictly lower triangular (default is none strict).
...
Sometimes some matrices of the list are omitted (like in the case of the cholesy)
...
L<decompositionLU|#decompositionLU>,
L<decompositionLUCrout|#decompositionLUCrout>,
...
The result will be a L<lower triangular matrix|#is-lower-triangular> matrix called G
...
This output format is also known as I<LDL>. You get the second L matrix easily
by transposing the L you got.
