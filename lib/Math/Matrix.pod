...
=item conversion: L<Bool|#bool>, L<Numeric|#numeric>, L<Str|#str>, L<Array|#array>, L<Hash|#hash>, L<list|#list>, list-rows, list-columns, L<gist|#gist>, L<perl|#perl>
...
=head3 narrowest-cell-type, widest-cell-type
