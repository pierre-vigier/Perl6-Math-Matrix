...
=item :DEFAULT (same as no tag, most <ops|#operators> will be exported)
=item :MM (only <MM|#new--> op exported)
=item :ALL
...
=begin table
    ...
    infix:-             subtract
    infix:*             multiply
    infix:⋅,dot         dotProduct
    infix:÷             dotProduct inverted
    infix:**            dotProduct inverted
    infix:⊗,x           tensorProduct
    circumfix:｜..｜       determinant
    circumfix:‖..‖      norm
    postcircumfix:[..]  AT-POS    
=end table
