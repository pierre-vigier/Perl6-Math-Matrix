...
=item L<numeric properties|#numeric-properties>: L<size|#size>, L<density|#density>, L<trace|#trace>, L<determinant|#determinant>, L<rank|#rank>, L<kernel|#kernel>, L<norm|#norm>, L<condition|#condition>, L<minor|#minor>, L<narrowest-cell-type|#narrowest-cell-type>, L<widest-cell-type|#widest-cell-type>
...
=item L<matrix math ops|#matrix-math-operations>: L<equal|#equal>, L<add|#add>, L<subtract|#subtract>, L<add-row|#add-row>, L<add-column|#add-column>, L<multiply|#multiply>, L<multiply-row|#multiply-row>, L<multiply-column|#multiply-column>, L<dotProduct|#dotproduct>, L<tensorProduct|#tensorproduct>
...
An orthogonal matrix multiplied (L<dotProduct|#dotproduct>) with its transposed derivative (T)
...
Inverse matrix regarding to matrix multiplication (see L<dotProduct|#dotproduct>).
...
=item infix ⋅ dot  -->  L<dotProduct|#dotproduct>
=item infix ÷  -->  dotProduct L<inverted|#inverted>
=item infix **  -->  dotProduct inverted
=item infix ⊗ x  -->  L<tensorProduct|#tensorproduct>
