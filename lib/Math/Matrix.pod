...
=head1 METHODS
=item constructors: L<new []|#new-->, L<new ''|#new---1>, new-zero, new-identity, new-diagonal, new-vector-product
...
=item list like ops: L<elems|#elems>, L<cont|#cont>, L<equal|#equal>, L<map|#map>, map-row, map-column, map-cell, reduce, reduce-rows, reduce-columns
=item structural ops: move-row, move-column, swap-rows, swap-columns, splice-rows, splice-columns
=item matrix math ops: L<add|#add>, L<subtract|#subtract>, add-row, add-column, multiply, multiply-row, multiply-column, dotProduct, tensorProduct
